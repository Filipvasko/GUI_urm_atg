...
"border-color: rgb(0, 85, 255);")
        self.set_yaw_model_text.setTextInteractionFlags(Qt.TextInteractionFlag.LinksAccessibleByMouse|Qt.TextInteractionFlag.TextEditable)
